...
public class BubbleSortAssignment {
	...
	public static void main(String[] args) {
		...
		while(flag)
		{
			...
			System.out.printf("%14s", "Random Order");
			System.out.printf("%14s", "1");
			System.out.printf("%14s", "2");
			System.out.printf("%14s", "3");
			System.out.printf("%14s", "4");
			System.out.printf("%14s", "5");
			System.out.printf("%14s", "Average");
			System.out.println();
			System.out.printf("%14s", "Bubble sort");
			for(int i = 1; i<=5; i++)
			{
				System.out.printf("%14.3f", sortTimes[1][i]);
			}
			System.out.printf("%14.3f", easyAverage(sortTimes, 1));
			System.out.println();
			
			
			System.out.printf("%14s", "Optimial BS");
			for(int i = 1; i<=5; i++)
			{
				System.out.printf("%14.3f", sortTimes[2][i]);
			}
			System.out.printf("%14.3f", easyAverage(sortTimes, 2));
			System.out.println();
			
			
			System.out.printf("%14s", "Modified BS");
			for(int i = 1; i<=5; i++)
			{
				System.out.printf("%14.3f", sortTimes[3][i]);
			}
			System.out.printf("%14.3f", easyAverage(sortTimes, 3));
			System.out.println();
			
			
			System.out.printf("%14s", "Reverse BS");
			for(int i = 1; i<=5; i++)
			{
				System.out.printf("%14.3f", sortTimes[4][i]);
			}
			System.out.printf("%14.3f", easyAverage(sortTimes, 4));
